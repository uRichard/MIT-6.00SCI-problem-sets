...
class League:
    ...
    def play_hand(self,hand):
        ...
        while counter != 0:
            ...
            trend_home_team = self.find_trend(home_team_name, match_day_num,10)
            print("\nTrend in last Matches: ",home_team_name)
            for t in trend_home_team:
                print(t)
    
            #trend_away_team = self.find_trend(away_team_name, match_day_num)
            trend_away_team = self.find_trend(away_team_name, match_day_num,10)
            print("\n")
...
def main():
    ...
    match_day_hand = 100#starting at match dayu 40
