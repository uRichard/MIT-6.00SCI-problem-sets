...
class League:
    ...
    def play_hand(self,hand):
        ...
        while counter != 0:
            ...
            goals_scored = self.goals_scored(home_team_name,match_day_num,num_of_last_matches)
            #goals_scored = goals_scored.re
            freq_goals_scored = self.get_freq(goals_scored)
            goals_conceded = self.goals_conceded(home_team_name,match_day_num ,num_of_last_matches)
            freq_goals_conceded = self.get_freq(goals_conceded)
            ...
            goals_scored_away_ = self.goals_scored(away_team_name,match_day_num ,num_of_last_matches)
            freq_goals_scored_away_ = self.get_freq( goals_scored_away_)
            goals_conceded_away_ = self.goals_conceded(away_team_name,match_day_num ,num_of_last_matches)
            freq_goals_conceded_away_ = self.get_freq(goals_conceded_away_ )
            ...
            print("\nABOUT: key: value\ne.g 1:2 Twice he has scored or conceded 1 goals.\nGoals:[1,2,3,4], the first element is the first goal i.e most recent match, 1.")
    ...
    def goals_conceded(self, team_name, match_day, num):
        """Computes and returns goals conceded
        return: list[2,2,3,4]
        """
        last_matches = self.find_matches_played(team_name, match_day, num)
        total = []
    ...
    def goals_scored(self, team_name,match_day,num):
        """Computes the goals scored
        return: list of goals scored e.g [1,2,3,4,5]
        """
        last_matches = self.find_matches_played(team_name,match_day,num)
...
def main():
    ...
    #ENGLAND
    #filename = "E0.csv" # English Premier League. start at MATCHDAY 26
    #filename = "E0_2021_22.csv" #English Premier League 2021/22
   
    #filename = "E1.csv" #English Championship  start at MATCHDAY 12
    #filename = "E1_2008_2009.csv" #championship old
    #filename = "E1_2010_2011.csv"
    #filename = "E2.csv" #English League 1 #start at MATCHDAY 15
    ...
    #filename="F2.csv" # FRENCH DIVISION 1.# start at MATCHDAY 32
    #filename = "F2_2021_22.csv" # start at MATCHDAY 20
    ...
    filename = "laliga2_.csv" #matches from 2010-2017
    ...
    #BELGIUM
    #filename = "B1.csv" # start at MATCHDAY 18
    ...
    #ARGENTINA from 2012
    #filename ="ARG.csv" #start at matcday 29
    ...
    #filename = "CHN.csv"
     ...
     #Japan
    #filename = "JPN.csv"# start at MATCHDAY 9
    ...
    match_day_hand = 15 #Default matchday 9
